...
public class FocusProcessView extends View {
    ...
    public FocusProcessView(Context context) {
        this(context, null);
    }

    public FocusProcessView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FocusProcessView(Context context, AttributeSet attrs, int defStyleAttr) {
