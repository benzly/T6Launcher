    ...
    private void updateFilter() {
        if (mGhostModeEnabled) {
            if (sGhostModeMatrix == null) {
                ...
                sTempMatrix.set(new float[] {range, 0, 0, 0, GHOST_MODE_MIN_COLOR_RANGE, 0, range, 0, 0, GHOST_MODE_MIN_COLOR_RANGE, 0, 0,
                        range, 0, GHOST_MODE_MIN_COLOR_RANGE, 0, 0, 0, 1, 0});
